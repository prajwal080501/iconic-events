...
const Header = ({ openModal, handleComponent }) => {
  ...
  return (
    <motion.nav
      ...
      className="hidden lg:flex fixed top-0 lg:w-[70%] lg:mx-auto mt-6 left-0 right-0 z-30 text-white px-5 py-2 items-center bg-black/40 backdrop-blur-lg bg-opacity-30 h-fit justify-between rounded-3xl">
